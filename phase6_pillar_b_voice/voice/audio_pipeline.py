...
from phase6_pillar_b_voice.voice.stt_engine import STTEngine, TranscriptResult, transcribe as _default_transcribe
from phase6_pillar_b_voice.voice.tts_engine import TTSEngine, SynthesisResult, synthesise as _default_synthesise
from phase6_pillar_b_voice.voice.vad import VADEngine, VADResult
from phase6_pillar_b_voice.voice.voice_logger import VoiceLogger, get_default_logger
...
class AudioPipeline:
    ...
    def _scrub(text: str) -> tuple[str, bool, list[str]]:
        ...
        from phase6_pillar_b_voice.voice.voice_logger import _scrub as _vl_scrub
